 ...
 *	Summary 		        : 
 *	
 *	프리팹창에서 UI 작업할 때 Root Canvas를 변경하지 못한 문제때문에
 *	임의의 해상도로 강제로 변경해주는 Script.
 *	
 *	방식은 프리팹창이 켜졌을 때 프리팹의 Root Object에 Resizer를 AddComponent
 *	프리팹 창을 닫으면 AddComponent 한 것을 Destroy합니다.
 *	
 *	출처
 *	https://forum.unity.com/threads/any-way-to-set-canvas-settings-for-prefab-mode.569923/
 *	
 *	원본 코드
 *	https://raw.githubusercontent.com/menshikh/UnityUtils/master/Assets/PrefabStageCanvasSize.cs
 *	
...
static class PrefabStageCanvasSize
{
    ...
    public class Resizer : MonoBehaviour
    {
        ...
        public Mode CanvasSizeMode = Mode.NativeBehaviour;
